  ...
  return (
    <div className={isDarkMode?"experience-card":"experience-card-light"}>
      <pre className="experience-details">
        ...
        <span className='curlly-braces-light'>{'{\n'}</span>
        &nbsp;&nbsp;
        <span className={isDarkMode?"braces-color":"braces-color-light"}>
          ...
          <span className={isDarkMode?'curlly-braces':"curlly-braces-light"}>,{'\n'}</span>
        &nbsp;&nbsp;
        <span className={isDarkMode?"braces-color":"braces-color-light"}>
          Period:</span> 
        ...
        <span className={isDarkMode?'curlly-braces':"curlly-braces-light"}>,{'\n'}</span>
        &nbsp;&nbsp;<span className={isDarkMode?"braces-color":"braces-color-light"}>techStack:</span> <span className='curlly-braces-light'>[</span><span className={isDarkMode?"value-color":"value-color-light"}>
          {work.techStack.map((tech, index) => (
            <span  key={index}>
              '{tech}'{index < work.techStack.length - 1 ? ', ' : ''}
            </span>
          ))}
        </span><span className="curlly-braces-light">],{'\n'}</span>
        ...
        {'\n'}
        <span className='curlly-braces-light'>{'};'}</span>
      </pre>
    </div>
  );
};
